...
const AdvisorNavbar: React.FC = () => {
  ...
  <li className="py-3 flex justify-between items-center text-gray-700 hover:bg-gray-100 transition duration-200">
    <Link href="/advisor-profile" className="flex-1">
      Advisor Profile
    </Link>
    <FaChevronRight className="ml-2 text-gray-500" />
  </li>
  <li className="py-3 flex justify-between items-center text-gray-700 hover:bg-gray-100 transition duration-200">
    <Link href="/payment-history-advisor" className="flex-1">
      Payment History
    </Link>
    <FaChevronRight className="ml-2 text-gray-500" />
  </li>
