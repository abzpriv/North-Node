...
const AdvisorPaymentHistory: React.FC = () => {
  ...
  return (
    <section className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto mt-16 py-8 px-4">
        <h2 className="text-4xl font-bold text-customGold text-center mb-8">Advisor Payment History</h2>
...
export default AdvisorPaymentHistory;
