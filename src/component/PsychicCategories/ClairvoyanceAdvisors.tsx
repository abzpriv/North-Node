...
const ClairvoyanceAdvisors: React.FC = () => {
 ...
 const handleLogout = () => {
  ...
  <nav className={styles.nav}>
    ...
    color: '#FFFFFF', 
                     ...
                     Clairvoyance Advisors
                     </span>
                       </h2>
                       <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                      Gaining information about an object or event without sensory input.
                      </p>
                      </div>
                     </section>
                  </section>
  ...
  <div className="mt-14 flex flex-col md:flex-col lg:flex-col justify-between items-center space-y-4 lg:space-y-0">
    <h2 className="text-2xl sm:text-3xl font-vogue font-thin text-white">
      <span style={{
    textShadow: `
      0 0 5px rgba(199, 145, 0, 0.6),   
      0 0 10px rgba(199, 145, 0, 0.7),  
...
export default ClairvoyanceAdvisors;