...
const TelepathyAdvisors: React.FC = () => {
...
const handleLoadMore = () => {
  ...
  <nav className={styles.nav}>
    ...
    color: '#FFFFFF', 
                     ...
                     Telepathy Advisors
                      ...
                      The ability to transmit thoughts directly from one person to another.
                      </p>
                      </div>
                     </section>
                  </section>
  ...
  <div className="mt-14 flex flex-col md:flex-col lg:flex-col justify-between items-center space-y-4 lg:space-y-0">
    <h2 className="text-2xl sm:text-3xl font-thin font-vogue  text-white">
      <span style={{
    textShadow: `
...
export default TelepathyAdvisors;